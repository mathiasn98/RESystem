...
@section('content')
    <div class="container pl-1 pr-1">
        <form id="editProject" method="POST" action="{{ route('project.update', [$project->id]) }}" enctype="multipart/form-data">
            @method('PUT')
            @csrf
            <div class="form-group">
                <h2 style="display:inline-block">Ubah Proyek</h2>
                <a class="btn btn-outline-danger float-right ml-2" href="{{ URL::previous() }}" style="display:inline-block">Batal</a>
                <button id="save" type="submit" class="btn btn-outline-success float-right" style="display:inline-block">Simpan</button>
            </div>
                ...
                <div class="card-body">
                    <table class="table table-bordered table-striped">
                        ...
                        <tr class="form-group">
                            ...
                            <td style="width:85%">
                                <input type="text" class="form-control required" name="name" value="{{ $project->name }}">
                            </td>
                        </tr>
                        <tr class="form-group">
                            <td style="width:15%">
                            ...
                            <td style="width:85%">
                                <textarea class="form-control required" name="description">{{ $project->description }}</textarea>
                            </td>
                        </tr>
                        <tr class="form-group">
                            <td style="width:15%">
    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            var contributors = {!! json_encode($contributors->toArray()) !!};
            ...
            $(contributorDiv).on("click", "#addContributor", function(e) {
                e.preventDefault();
            ...
            $('#save').on('click', function(e) {
                ...
                if (checkContributor()) $('#editProject').submit();
            });
        });
